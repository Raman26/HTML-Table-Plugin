...
function so_wp_ajax_function(){
  	$vid=$_POST['vid'];
	$ul='https://jsonplaceholder.typicode.com/users/'.$vid;
	$args=array(
		'method'=>'GET'
	);
	$response=wp_remote_get($ul,$args);
	if(is_wp_error($response)) {
		$error_message=$response->get_error_message();
		echo 0;
	}	
	$result=json_decode(wp_remote_retrieve_body($response));
	echo "Name: ".$result->name."<br>Email: ".$result->email."<br>Address: ".$result->address->street.", ".$result->address->suite.", ".$result->address->city; 
